...
/**
 * Demo program for filling closed parts of an image.
 * 
 * @author Luka Mesaric
 */
public class Bojanje2 {
	...
	private static final FillAlgorithm bfs = new FillAlgorithm() {
		...
		@Override
		public String getAlgorithmTitle() { return "Moj bfs!"; }
	...
	private static final FillAlgorithm dfs = new FillAlgorithm() {
		...
		@Override
		public String getAlgorithmTitle() { return "Moj dfs!"; }
	...
	private static final FillAlgorithm bfsv = new FillAlgorithm() {
		...
		@Override
		public String getAlgorithmTitle() { return "Moj bfsv!"; }
